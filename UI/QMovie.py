...
class loadFace(QWidget):
    def __init__(self, gifname, title='', parent=None):
        """Creates the loading gear as QMovie and its label."""
        QWidget.__init__(self, parent)
        self.movie = QtGui.QMovie(gifname)
        #self.movie.setFileName(gifname)
        self.movie.setCacheMode(QtGui.QMovie.CacheAll)
        self.movie.start()
        self.loading = QtWidgets.QLabel(title)
